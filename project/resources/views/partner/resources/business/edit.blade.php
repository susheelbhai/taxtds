<x-partner-layout>
        ...
        $details = [
            [
                ...
                'form'=> [
                    ...
                    ['name'=> 'services', 'lbl'=>'Services', 'value'=> $data->services, 'type'=>'editor'],
                ]
            ], 
            [
                'id'=>'02',
    ...
    @endphp
    <x-partner.form.form_wizard1 heading="Add Business" :details="$details" :action="route('partner.business.update',$data->id)">
        @method('patch')
    </x-partner.form.form_wizard1>
